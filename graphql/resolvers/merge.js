...
const founder = founderId=>{
    return Founder.findById(founderId).then(founder=>{
        return {...founder._doc, _id: founder.id, createdProducts: products.bind(this, founder._doc.createdProducts), votedProducts:products.bind(this, founder._doc.votedProducts)}
    }).catch(err=>{
        throw err;
    })
}
