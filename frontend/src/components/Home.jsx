...
export default class Home extends Component{
    ...
    productDay=()=>{
        ...
        .then(resData=>{
            this.setState({dayPName:resData.data.productDay.name, dayPDes:resData.data.productDay.description, dayPLink:resData.data.productDay.link});
            console.log(this.state)
        }).catch(err =>{
            console.log(err)
        });
                        ...
                        <div className="col-md-12 shadow product-box">
                            <div className="row">
                                ...
                                <div className="col-md-4 offset-2 text-center">
                                    ...
                                    <Link to="/">
                                        <input onClick={this.voteHandler.bind(this,product._id)} type="submit" className="vote-btn" value="vote"/>
                                    </Link>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-8">
                                    <p>Link: <a href="">{product.link}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-3 shadow dayProduct">
                    <div className="row">
                        <div className="col-md">
                            <h4 className="text-center gap-up welcome">Product of the Day</h4>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-10 offset-1">
                            <p><a href="">{this.state.dayPLink}</a></p>
                        </div>
                    </div>
